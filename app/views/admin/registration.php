...
<div class="container mt-3">
	<div class="row justify-content-center">
		<div class="col-md-6">
			<?php 
			echo form_open('admin/registration',array('id'=>'register_form')); 
			echo form_fieldset('Admin Registration');
			?>
			...
			<div class="form-group">
				<?php
			    echo form_label('Security Code', 'security',array('class'=>'form-control-label'));
			    if (@$security_error) {
			   		echo form_password(array('class'=>'form-control is-invalid','id'=>'security','placeholder'=>'Security Code','name'=>'security')); 
			   		echo "<div class='invalid-feedback'>".$security_error."</div>";
			    }else{
			   		echo form_password(array('class'=>'form-control','id'=>'security','placeholder'=>'Security Code','name'=>'security')); 
			    }
			    ?>
			</div>
			<div class="row justify-content-center">
